...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>維修項目單</h1>
                <asp:Label ID="Label1" runat="server" Text="編號0971" Font-Size="X-Large"></asp:Label><br/>
            <asp:Label ID="Label2" runat="server" Text="聯絡方式"  Font-Size="X-Large"></asp:Label><asp:DropDownList ID="ddl_Type" runat="server">
            ...
            </asp:DropDownList><asp:TextBox runat="server" ID="tb_Number"></asp:TextBox><br/>
            <asp:Label ID="Label3" runat="server" Text="地址"  Font-Size="X-Large"></asp:Label><asp:DropDownList ID="ddl_City" runat="server">
